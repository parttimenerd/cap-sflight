...
public interface BookingSupplement extends CdsData {
  ...
  @CdsName(IS_ACTIVE_ENTITY)
  BookingSupplement isActiveEntity(Boolean isActiveEntity);

  @CdsName(HAS_ACTIVE_ENTITY)
  Boolean hasActiveEntity();

  @CdsName(HAS_ACTIVE_ENTITY)
  BookingSupplement hasActiveEntity(Boolean hasActiveEntity);

  @CdsName(HAS_DRAFT_ENTITY)
  Boolean hasDraftEntity();

  @CdsName(HAS_DRAFT_ENTITY)
  BookingSupplement hasDraftEntity(Boolean hasDraftEntity);

  @CdsName(DRAFT_ADMINISTRATIVE_DATA)
  DraftAdministrativeData draftAdministrativeData();

  @CdsName(DRAFT_ADMINISTRATIVE_DATA)
  BookingSupplement draftAdministrativeData(Map<String, ?> draftAdministrativeData);

  @CdsName(DRAFT_ADMINISTRATIVE_DATA_DRAFT_UUID)
  String draftAdministrativeDataDraftUUID();

  @CdsName(DRAFT_ADMINISTRATIVE_DATA_DRAFT_UUID)
  BookingSupplement draftAdministrativeDataDraftUUID(String draftAdministrativeDataDraftUUID);

  @CdsName(SIBLING_ENTITY)
  BookingSupplement siblingEntity();

  @CdsName(SIBLING_ENTITY)
  BookingSupplement siblingEntity(Map<String, ?> siblingEntity);
