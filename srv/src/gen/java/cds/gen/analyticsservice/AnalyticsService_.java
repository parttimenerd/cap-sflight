...
@CdsName("AnalyticsService")
public interface AnalyticsService_ {
  String CDS_NAME = "AnalyticsService";
  ...
  Class<Bookings_> BOOKINGS = Bookings_.class;

  Class<FlightConnection_> FLIGHT_CONNECTION = FlightConnection_.class;

  Class<Travels_> TRAVELS = Travels_.class;
